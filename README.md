# 原`Avascriptions`铭文项目的资料整理备份

## 文件说明

- `backup`: 所有原项目仓库中的原始源码备份
- `asc20market-contracts`: ASC20 市场智能合约。查看[文档](https://docs.avascriptions.com/)获取更多信息。
- `ASIPs`: Avascriptions 协议和 ASC-20 协议的提案仓库
...
- 官网: [https://avascriptions.com](https://avascriptions.com/) 已无法打开,无备份
...
- 文档: [https://docs.avascriptions.com/](https://docs.avascriptions.com/) 可打开,已备份
